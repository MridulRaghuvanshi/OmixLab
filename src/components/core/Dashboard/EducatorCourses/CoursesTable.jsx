                ...
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    {course.status === COURSE_STATUS.DRAFT ? (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-gray-800 px-2 py-[2px] text-[12px] font-medium text-pink-100">
                        <HiClock size={14} />
                        Drafted
                      </p>
                    ) : (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-gray-800 px-2 py-[2px] text-[12px] font-medium text-yellow-100">
