...
export default function ChipInput({
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <label className="text-sm text-[rgb(245,245,245)]" htmlFor={name}>
      ...
      <div className="flex w-full flex-wrap gap-y-2">
        ...
        {chips.map((chip, index) => (
          <div
            key={index}
            className="m-1 flex items-center rounded-full bg-yellow-400 px-2 py-1 text-sm text-[rgb(245,245,245)]"
          >
